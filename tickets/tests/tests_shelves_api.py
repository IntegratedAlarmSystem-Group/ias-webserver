...
class RetreiveRegistryTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.retrieve_permission = Permission.objects.get(
            codename='view_shelveregistry')

    def test_api_cannot_retreive_registry_to_unauthenticated_user(self):
        client = APIClient()
        response = client.get(self.url, format='json')
        self.assertEqual(
            response.status_code,
            status.HTTP_401_UNAUTHORIZED,
            """ The server should not retreive a registry
                for an unauthenticated user
            """
        )

    def test_api_cannot_retreive_registry_to_unauthorized_user(self):
        client = APIClient()
...
#             )
#         ]
#         self.registry_1 = self.registries[0]
#         self.registry_2 = self.registries[1]
#         self.registry_2.unshelve()
#         self.registry_3 = self.registries[2]
