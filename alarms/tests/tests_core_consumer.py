...
class TestCoreConsumer:
    ...
    #         "valueType": "ALARM"
    #     }
    #     # sentToConverterTStamp = CoreConsumer.get_timestamp_from(msg['sentToConverterTStamp'])
    #     # receivedFromPluginTStamp = CoreConsumer.get_timestamp_from(msg['receivedFromPluginTStamp'])
    #     # convertedProductionTStamp = CoreConsumer.get_timestamp_from(msg['convertedProductionTStamp'])
    #     # sentToBsdbTStamp = CoreConsumer.get_timestamp_from(msg['sentToBsdbTStamp'])
    #     # readFromBsdbTStamp = CoreConsumer.get_timestamp_from(msg['readFromBsdbTStamp'])
    #     productionTStamp = CoreConsumer.get_timestamp_from(msg['productionTStamp'])
    #
    ...
    #         "iasValidity": "RELIABLE",
    #         "fullRunningId": "(Monitored-System-ID:MONITORED_SOFTWARE_SYSTEM)" + \
    #         "@(plugin-ID:PLUGIN)@(Converter-ID:CONVERTER)@(AlarmType-ID:IASIO)",
    #         "valueType": "ALARM"
    #     }
    #     expected_alarm = Alarm(
    #         value=2,
